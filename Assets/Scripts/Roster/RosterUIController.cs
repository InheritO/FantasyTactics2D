...
public class RosterUIController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // 142번째 줄(ValidateReferences)에서는 null까지 체크하는데 여기는 안 하고 있어서 통일함.
        ...
        var required = new (Object obj, string name)[]
   {
    ...
    private void CycleMainHandWeapon()
    {
        ...
        // availableWeapons 배열에 할당되지 않은(null) 슬롯이 있으면 w.slotType에서 NullReferenceException이 났었음.
